...
de acordo com as instruções do case, onde tempo de deslocamento e distância seria a forma principal de avaliar.
...
## Identificaremos **1 principal hospital** de cada cidade com o **melhor resultado "GERAL"**.
...
Abaixo temos os hospitais remanescentes da lista tríplice, é
interessante salientar que esses hospitais tiverem bons resultados. São
futuras oportunidades de integração a empresa dado o ótimo nível
demonstrado na avaliação seja por meio de seus serviços e práticas bem
aplicadas, como também na baixo tempo de deslocação em relação a empresa
dada o estado e município onde se esta alocado.

Todos os hospitais selecionados para essas
últimas etapas tanto da lista mais bem avaliadas como na lista de
sugestão abaixo, são hospitais de cuidados agudos, ou seja, são maiores,
oferecem mais serviços médicos, especialidades e infraestrutura maior.
Tendo isso em vista, esse poderia ser um ponto de atenção para focalizar
futuras integrações de hospitais, dada maior cobertura de atendimento,
ampla variedade de serviços, tem vínculo com seguradores privadas ou
mesmo programas governamentais, além de estrutura com funcionalidade 24
horas por dia e 7 dias por semana. Assim, seria muito mais benéfico a
empresa ter parcerias com estrutura, qualidade e capilaridade maior,
consequentemente resultando em maiores resultados financeiros.

Ordem de prioridade para os demais hospitais rankeados:
